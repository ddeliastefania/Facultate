...
namespace FormProiect2020 {
    ...
    public partial class masterDataSet : global::System.Data.DataSet {
        ...
        public partial class UsersDataTable : global::System.Data.TypedTableBase<UsersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public UsersRow AddUsersRow(string firstName, string lastName, string password, string email, string phone) {
...
namespace FormProiect2020.masterDataSetTableAdapters {
    ...
    public partial class UsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Users] ([firstName], [lastName], [password], [email], [phone])" +
                " VALUES (@firstName, @lastName, @password, @email, @phone);\r\nSELECT userID, firs" +
                "tName, lastName, password, email, phone FROM Users WHERE (userID = SCOPE_IDENTIT" +
                "Y())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Users] SET [firstName] = @firstName, [lastName] = @lastName, [password] = @password, [email] = @email, [phone] = @phone WHERE (([userID] = @Original_userID));
SELECT userID, firstName, lastName, password, email, phone FROM Users WHERE (userID = @userID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::FormProiect2020.Properties.Settings.Default.masterConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT userID, firstName, lastName, password, email, phone FROM dbo.Users";
        ...
        public virtual int Insert(string firstName, string lastName, string password, string email, string phone) {
            if ((firstName == null)) {
        ...
        public virtual int Update(string firstName, string lastName, string password, string email, string phone, int Original_userID, int userID) {
            if ((firstName == null)) {
                throw new global::System.ArgumentNullException("firstName");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string firstName, string lastName, string password, string email, string phone, int Original_userID) {
            return this.Update(firstName, lastName, password, email, phone, Original_userID, Original_userID);
        }
    }
