...
namespace ClientPostComment.BazaDeDateDataSetTableAdapters {
    ...
    public partial class PostsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Posts] WHERE (([PostId] = @Original_PostId) AND ([Date] = @Ori" +
                "ginal_Date))";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Posts] SET [Description] = @Description, [Domain] = @Domain, [Date]" +
                " = @Date WHERE (([PostId] = @Original_PostId) AND ([Date] = @Original_Date));\r\nS" +
                "ELECT PostId, Description, Domain, Date FROM Posts WHERE (PostId = @PostId)";
        ...
        public virtual int Fill(BazaDeDateDataSet.PostsDataTable dataTable) {
        ...
        public virtual BazaDeDateDataSet.PostsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            BazaDeDateDataSet.PostsDataTable dataTable = new BazaDeDateDataSet.PostsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(BazaDeDateDataSet.PostsDataTable dataTable) {
        ...
        public virtual int Delete(int Original_PostId, System.DateTime Original_Date) {
        ...
        public virtual int Update(string Description, string Domain, System.DateTime Date, int Original_PostId, System.DateTime Original_Date, int PostId) {
            if ((Description == null)) {
                throw new global::System.ArgumentNullException("Description");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Description, string Domain, System.DateTime Date, int Original_PostId, System.DateTime Original_Date) {
            return this.Update(Description, Domain, Date, Original_PostId, Original_Date, Original_PostId);
        }
    }
